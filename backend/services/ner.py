...
# Завантаження моделі spaCy для російської мови
nlp = spacy.load("ru_core_news_md")

def normalize_words(words):
    """Normalize words using spaCy lemmatization."""
    # Використовуємо lemmatization з spaCy
...
def get_weapons(mes, weapons_list_path=weapon_path):
    ...
    try:
        with open(weapons_list_path, "r", encoding="utf-8") as file:
            ...
            words_list = [w for w in weapons if w in mes.lower()]
        res = ", ".join(words_list)
        return res
